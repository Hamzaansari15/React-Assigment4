    ...
    return (
        <div className='main_header'>
            <div className='header_First_section'>
                <a id='header_link' href='#'>Turo has launched in New York! Tap to explore cars.</a>
            </div>
