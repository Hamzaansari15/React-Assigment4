...
const FrequentlyQuestion = () => {
    return (
        <div>
            <div className='second_heading my-5 container'>Frequently asked question</div>
            <div className='accordion_main_div my-5'>
                <div className='accordion_div'>
                    <Accordion defaultActiveKey="0" flush>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header><span className='accordion_heading'>What do I need to book a car on Turo?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header><span className='accordion_heading'>Do I need my own insurance?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
                        ...
                        <Accordion.Item eventKey="3">
                            <Accordion.Header><span className='accordion_heading'>What is the cancellation policy on Turo?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
                ...
                <div className='accordion_div'>
                    <Accordion defaultActiveKey="0" flush>
                        <Accordion.Item eventKey="4">
                            <Accordion.Header><span className='accordion_heading'>How do I get discounts when booking a car?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }} >
...
On your Account page, make sure you’ve checked the box to receive email notifications, and enable push notifications from the Turo app in your phone settings — we’ll send you occasional promo codes, discounts, and deals!
                        ...
                        <Accordion.Item eventKey="5">
                            <Accordion.Header><span className='accordion_heading'>What happens if I have an accident?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
                        ...
                        <Accordion.Item eventKey="6">
                            <Accordion.Header><span className='accordion_heading'>Can I get my car delivered to me?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
                        ...
                        <Accordion.Item eventKey="7">
                            <Accordion.Header><span className='accordion_heading'>What are the cleaning and safety policies on Turo?</span></Accordion.Header>
                            <Accordion.Body style={{ fontSize: '17px', lineHeight: '28px' }}>
...
export { Heading, SecondHeading, ImageSection, FrequentlyQuestion }